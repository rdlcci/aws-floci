...
**Want the "why would I ever add this" story instead of a component checklist?**
See [`docs/project-narrative.md`](./docs/project-narrative.md) — a single project
("Pixly") that grows stage by stage, where each component below gets introduced
because a previous, simpler architecture actually broke or became embarrassing. Use
it as the spine; use this file as the reference you consult at each stage.
